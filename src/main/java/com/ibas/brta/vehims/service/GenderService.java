...
import com.ibas.brta.vehims.model.configurations.Gender;
...
import com.ibas.brta.vehims.repository.GenderRepository;
...
public class GenderService {
    ...
    public List<?> getActiveList() {
        List<Gender> entities = genderRepository.findByIsActiveTrueOrderByNameEnAsc();
